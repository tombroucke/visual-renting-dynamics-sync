...
class QuoteRequested extends \WC_Email
{
    public function __construct()
    {
        ...
        $this->description    = __('When an order is successfully sent to Visual Renting Dynamics Sync, this e-mail is sent to the shop administrator.', 'visual-renting-dynamics-sync');
