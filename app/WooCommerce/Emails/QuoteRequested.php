...
class QuoteRequested extends \WC_Email
{
    public function __construct()
    {
        ...
        add_action('woocommerce_order_status_pending_to_quote-requested_notification', [$this, 'trigger']);
        add_action('woocommerce_order_status_failed_to_quote-requested_notification', [$this, 'trigger']);
    ...
    public function trigger($order_id, $order = false)
    {
        ...
        if ($this->is_enabled() && $this->get_recipient()) {
            ...
            $order->update_meta_data('_quote_requested_email_sent', 'true');
            $order->save();
        }
